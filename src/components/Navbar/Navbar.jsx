...
function Navbar({onMenuClick, searchQuery, setSearchQuery}) {
                    ...
                    <div className="flex items-center space-x-2 flex-shrink-0">
                        ...
                        <Link to="/">
                            <div className="flex items-center cursor-pointer">
                                <img src={youtube} alt="YouTube Logo" className="h-6 sm:h-7"/>
                  ...
                  YouTube
                    ...
                    <div className="flex items-center space-x-2 flex-shrink-0">
                        ...
                        <button className="flex items-center p-2 bg-gray-100 rounded-full hover:bg-gray-300">
                            <Plus size={20}/>
                            <span className="ml-1.5 text-sm font-medium sm:block">
                Create
              </span>
                        </button>
